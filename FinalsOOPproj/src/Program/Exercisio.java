...
//Class for handling exercise generation
public class Exercisio extends MainGUI  {

	private static final long serialVersionUID = 2090849533640055747L;
	...
	public static void generateExerciseSuggestions(int[] numberofExercises, int[] time) {
       ...
       */
		...
		for (int var1 = 0; var1 < numberofExercises[0]; var1++) {
			...
			fh.copyToCurrent(fh.getFilePath("../FinalsOOPproj/Exercises/endurance", randomizer(0,8)), time_endurance);
		...
		for (int var2 = 0; var2 < numberofExercises[1]; var2++) {
		    ...
		    fh.copyToCurrent(fh.getFilePath("../FinalsOOPproj/Exercises/strength", randomizer(0,9)), time_strength);
		...
		for (int var3 = 0; var3 < numberofExercises[2]; var3++) {
		    ...
		    fh.copyToCurrent(fh.getFilePath("../FinalsOOPproj/Exercises/balance", randomizer(0,9)), time_balance);
		...
		for (int var4 = 0; var4 < numberofExercises[3]; var4++) {
		    ...
		    fh.copyToCurrent(fh.getFilePath("../FinalsOOPproj/Exercises/flexibility", randomizer(0,9)), time_flexibility);
		}
	}
