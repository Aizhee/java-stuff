...
// This class is responsible for the main UI of the program.
...
public class MainGUI extends JFrame {
	...
	public static String profile_picture = "../FinalsOOPproj/Exercises/th.jpg";
	...
	public MainGUI() {
		...
		ImageIcon icon = new ImageIcon("../FinalsOOPproj/Exercises/handouts.png");
		...
		ImageIcon iconGIF = new ImageIcon("../FinalsOOPproj/Exercises/rest.gif");
		...
		ImageIcon icon1 = new ImageIcon("../FinalsOOPproj/Exercises/people.png");
