...
public class CreditGUI extends JFrame {
    ...
    public CreditGUI() {
        ...
        JLabel courseLabel = new JLabel("| BSCpE II-GF", JLabel.CENTER);
        courseLabel.setFont(new Font("Tahoma", Font.PLAIN, 15));
        courseLabel.setForeground(Color.BLACK);

        JLabel requirementLabel = new JLabel("This program is part of the Course Requirement for CPE05", JLabel.CENTER);
