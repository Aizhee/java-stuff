...
public class TimeTableMaker extends MainGUI{
	...
	public static String path = "../FinalsOOPproj/Exercises/current";
	...
	public static void LoadGif(String selectedItem) {
		...
		String gifPath = "../FinalsOOPproj/Exercises/gifs/" + selectedItem + ".gif";
		//resize the gif and keep its animation
	...
	public static void LoadFileContentToTextArea(String selectedItem) {
		...
		String path = "../FinalsOOPproj/Exercises/current/" + selectedItem;
