 ...
 * OOP Final Project
 */
// The first UI that the user will see when they open the program.
...
public class IntroGUI extends JFrame {
    ...
    public IntroGUI() {
        ...
        ImageIcon logo = new ImageIcon("../FinalsOOPproj/Exercises/actionLogo.png");
        ...
        start_btn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	...
            	if (!file.checkFileExists("../FinalsOOPproj/Exercises/usersettings.txt")) {
            		//set the tab to profile
            		//create a default usersettings.txt file
            		file.writeFile("../FinalsOOPproj/Exercises/usersettings.txt", "Enter Your Name\nExercises/th.jpg\n1\n1\n1\n1\n1\n1\nfalse\nfalse\nfalse\nfalse\n3\n0");
            		MainGUI.isNewUser = true;
