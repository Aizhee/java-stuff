...
public class moth404 {
    ...
    private static int generateKey() {
        ...
        final int[] constants = {23,26,3,75}; //TODO: Find the value of the constants [02/20/2024]
  
        int layer1 = (int)(5%6);// TODO: Find the 6 modulus 5 (converted into an int) and store it in layer1 variable
